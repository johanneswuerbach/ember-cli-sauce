...
case "${SAUCE_CONNECT_PLATFORM}" in
    linux)
        ...
        SC_DISTRIBUTION_SHASUM=0ae5960a9b4b33e5a8e8cad9ec4b610b68eb3520;;
    osx)
        SC_DISTRIBUTION_FMT=zip
        SC_DISTRIBUTION_SHASUM=9d9ecb49fbea70186d08aac7de6032546d856379;;
esac
SC_DISTRIBUTION=sc-4.3.8-${SAUCE_CONNECT_PLATFORM}.${SC_DISTRIBUTION_FMT}
